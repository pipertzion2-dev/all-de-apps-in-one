...
export const ROTHCO_THEMES: RothcoTheme[] = [
  ...
  { name: "NATO Green", primary: "#445246", accent: "#B0C4B4", surface: "#EAF0EC", ink: "#161A16" },
  { name: "Gunship", primary: "#3A3D39", accent: "#B8BAB6", surface: "#EDEDEC", ink: "#121311" },
];

export type ToolDefinition = {
  id: number;
  slug: string;
  /** H1 + &lt;title&gt; — tuned for “free … online / checker / tool” searches */
  title: string;
  /** Meta description (~150–160 chars) + AI insight context */
  shortDescription: string;
  /** Extra phrases for meta keywords + JSON-LD */
  keywords: string;
  theme: RothcoTheme;
};
...
export function getToolForLanding(landing: LandingDefinition): ToolDefinition | undefined {
  return toolBySlug.get(landing.embedToolSlug);
}
