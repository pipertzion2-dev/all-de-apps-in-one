...
function renderFrame(ctx, cssW, cssH, scrollOffset, bgColor) {
  ...
  for (const { x, theta } of coils)
    drawCoil(ctx, x, cy, rx, ryFull, spikeLen, theta, 'back')
  for (const { x, theta } of coils)
    drawCoil(ctx, x, cy, rx, ryFull, spikeLen, theta, 'spikes')
  for (const { x, theta } of coils)
    drawCoil(ctx, x, cy, rx, ryFull, spikeLen, theta, 'front')
