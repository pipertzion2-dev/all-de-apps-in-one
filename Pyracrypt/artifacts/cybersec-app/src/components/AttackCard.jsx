        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                ...
                {mutated.findings.slice(0, 4).map((f, i) => (
                  <li
                    ...
                    style={{
                      ...
                      padding: "8px 11px",
                      border:
                        "1px solid color-mix(in srgb,var(--danger) 14%,rgba(255,255,255,0.4))",
                  ...
                  >
                    ...
                    {f.failure ? (
                      <p style={{ margin: "3px 0 0", fontSize: 10.5, color: "var(--danger)" }}>
                        {f.failure}
                      </p>
                    ) : (
                      <p style={{ margin: "3px 0 0", fontSize: 10, color: "var(--success)" }}>
                        ✓ No failure
                      </p>
                    )}
                  </li>
          ...
          {attackSteps?.length > 0 && (
            <div>
              ...
              >
                {attackSteps.map((s, i) => (
                  <li key={i} style={{ fontSize: 11.5, color: "var(--text)", lineHeight: 1.55 }}>
                    {s}
                  </li>
                ))}
              </ol>
