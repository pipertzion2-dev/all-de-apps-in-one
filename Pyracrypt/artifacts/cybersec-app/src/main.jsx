...
function Root() {
  ...
  const skipIntro =
    typeof window !== "undefined" && new URLSearchParams(window.location.search).has("skip");
  ...
  return (
    <Router>
      ...
      <Switch>
        ...
        <Route>
          <div
            style={{ padding: "120px 80px", textAlign: "center", fontSize: 14, color: "#606870" }}
          >
            Page not found —{" "}
            <a href="/" style={{ color: "#6D91B3" }}>
              go home
            </a>
          </div>
        </Route>
