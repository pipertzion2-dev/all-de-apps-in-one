...
export default function LockPage() {
  ...
  const { busy, activeStepIndex, error, setSystem, runPipeline } = usePipelineStore();
            ...
            >
              <div
                style={{
                  ...
                  borderRadius: "50%",
                  background: "#6D91B3",
                  boxShadow: "0 0 6px #6D91B3",
                  animation: "led-pulse 0.8s ease-in-out infinite",
                }}
              />
              Step {Math.max(1, activeStepIndex + 1)} / 5 —{" "}
              {STEP_LABELS[Math.max(0, activeStepIndex)]?.split("…")[0]}
            </div>
          )}
        </div>
        ...
        {error && !busy && (
          <div
            style={{
              ...
              border: "1px solid rgba(190,100,80,0.3)",
              fontSize: 11,
              color: "#b06858",
              textAlign: "center",
              width: "100%",
          ...
          <button
            ...
            onMouseEnter={(e) =>
              (e.currentTarget.style.background =
                "linear-gradient(135deg, rgba(109,145,179,0.25) 0%, rgba(172,129,175,0.25) 100%)")
            }
            onMouseLeave={(e) =>
              (e.currentTarget.style.background =
                "linear-gradient(135deg, rgba(109,145,179,0.15) 0%, rgba(172,129,175,0.15) 100%)")
