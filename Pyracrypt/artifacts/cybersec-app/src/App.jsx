        ...
        {featCount > 0 && (
          <div
            style={{
              ...
              borderRadius: 20,
              background:
                "linear-gradient(to bottom, rgba(255,255,255,0.88) 0%, rgba(220,224,232,0.82) 100%)",
          ...
          >
            <span
              style={{
                ...
                display: "inline-block",
                background: "#DCE5CA",
                boxShadow: "0 0 5px rgba(220,229,202,0.9)",
  ...
  return (
    ...
    >
      ...
      <div style={{ position: "relative", zIndex: 1, maxWidth: 680 }}>
        ...
        >
          AI-powered attack surface mapping, real-time threat visualization, and automated
          remediation — deployed in one session.
        </p>
  ...
  return (
    ...
    >
      <div style={{ maxWidth: 1280, margin: "0 auto" }}>
            ...
            {Object.keys(cats).map((g) => (
              <button
                ...
                style={{
                  ...
                  boxShadow:
                    active === g
                      ? "0 1px 0 rgba(255,255,255,0.8) inset, 0 2px 5px rgba(0,0,0,0.12)"
                      : "none",
                }}
              >
                {g}
                {g !== "All" && cats[g]?.length > 0 ? ` (${cats[g].length})` : ""}
              </button>
            ))}
          </div>
        </div>
        ...
        {features.length === 0 ? (
          <div style={{ textAlign: "center", padding: "56px 0", color: "#606870", fontSize: 11 }}>
      ...
      >
        ...
        <div style={{ display: "flex", gap: 24, flexWrap: "wrap", alignItems: "center" }}>
          {["POST /pipeline", "POST /suite", "GET /features"].map((r) => (
            <span
              key={r}
              style={{ fontSize: 8.5, color: "#707880", letterSpacing: "0.08em", fontWeight: 700 }}
            >
              {r}
            </span>
          ))}
