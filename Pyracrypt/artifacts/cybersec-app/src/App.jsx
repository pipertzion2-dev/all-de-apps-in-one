...
const clutetyGraphic = '/clutety-logo.png'
const clutetyLogo = '/clutety-logo.png'
      ...
      <div style={{ position: 'relative', zIndex: 1, maxWidth: 680 }}>
        ...
        <h1 style={{
          ...
          <span style={{
            color: '#6D91B3',
            display: 'block',
            textShadow: '0 0 28px rgba(109,145,179,0.45)',
        ...
        <CamoCTAWrapper style={{ marginBottom: 56 }}>
          <CTA label="Analyze My System →" onClick={() => navigate('/lock')} large />
          <CTA label="See Capabilities" onClick={() => scrollTo('capabilities')} outline large />
        </CamoCTAWrapper>
