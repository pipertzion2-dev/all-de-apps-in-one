  ...
  return (
    <div className="app">
      <header className="seo-header">
        <h1>Free Text to 3D Model Generator Online</h1>
        <p className="hero-sub">
          Type a brief. Get a production-style 3D model preview in under 3 seconds — no account, no software, no friction.
        </p>
