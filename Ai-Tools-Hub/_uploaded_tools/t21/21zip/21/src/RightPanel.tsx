...
const STEP_COPY: Record<Mode, string> = {
  hardware: 'You just previewed the "Concept → Schematic" step. In the full Hardware pipeline you get BOM generation, versioning, and export to fabrication.',
      ...
      <div className="mapping-copy">
        {preview ? (
          ...
          <>
            ...
            <p>Generate a preview to see which step you’re in and what the full workflow offers.</p>
          </>
        )}
      </div>
