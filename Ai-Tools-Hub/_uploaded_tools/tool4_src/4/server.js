...
function getMimeType(ext) {
  const map = { '.html': 'text/html', '.css': 'text/css', '.js': 'application/javascript', '.ico': 'image/x-icon', '.woff2': 'font/woff2', '.woff': 'font/woff' };
...
const server = http.createServer((req, res) => {
  ...
  if (req.method === 'GET' && (url === '/' || url === '/index.html' || url.endsWith('.css') || url.endsWith('.js') || url.endsWith('.woff2') || url.endsWith('.woff'))) {
