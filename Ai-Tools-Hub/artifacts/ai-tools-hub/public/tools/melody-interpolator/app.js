  ...
  function renderArtifact(mode, description, constraints) {
    ...
    switch (config.artifact) {
      ...
      case 'schematic':
        ...
        if (constraints.materials) root.appendChild(document.createElement('br')), root.appendChild(document.createTextNode('Materials: ' + constraints.materials));
        break;
      case 'idea-report':
      ...
      case 'bom':
        ...
        if (constraints.budget) root.appendChild(document.createElement('br')), root.appendChild(document.createTextNode('Budget: ' + constraints.budget));
        break;
      default:
