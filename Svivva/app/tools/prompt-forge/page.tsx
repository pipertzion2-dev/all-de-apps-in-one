...
const EXAMPLES = [
  {
    label: "Summariser",
    system: "Summarise the following text in 3 bullet points. Be concise.",
    user: "Artificial intelligence (AI) is transforming industries worldwide. From healthcare diagnostics to financial modeling, AI systems are now capable of performing tasks that once required human expertise. However, this rapid advancement raises important questions about ethics, employment, and the future of human-machine collaboration.",
  },
  {
    label: "JSON extractor",
    system:
      "Extract structured data from the text and return valid JSON only. Schema: {name: string, email: string, company: string}",
    user: "Hi, I'm Sarah Chen from Acme Corp. You can reach me at sarah.chen@acme.com. Looking forward to our meeting.",
  },
  {
    label: "Tone rewriter",
    system: "Rewrite the following text in a professional, concise business tone.",
    user: "hey so basically our product is like really cool and stuff and customers love it so much and we think you should def check it out asap!!",
  },
];
        ...
        <div className="max-w-5xl mx-auto px-4 py-10">
          <div className="flex items-center justify-between flex-wrap gap-3 mb-4">
            ...
            <TentpoleStepIndicator
              step={0}
              total={2}
              currentLabel="Test your prompt"
              nextLabel="Deploy as live API"
            />
          </div>
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-white/60 mt-1 text-lg">
                Test, refine and compare AI prompts instantly. No signup, no API key needed.
              </p>
              <div className="flex flex-wrap gap-2 mt-3">
                {["GPT-4o", "GPT-4o mini", "GPT-4 Turbo", "Free to use", "Token counter"].map(
                  (t) => (
                    <span
                      key={t}
      ...
      <div className="max-w-5xl mx-auto px-4 py-8 space-y-6">
          ...
          <div className="rounded-2xl border border-border bg-card overflow-hidden flex flex-col min-h-[400px]">
              ...
              <div className="flex items-center gap-2">
                ...
                {result && (
                  <button
                    ...
                    className="text-xs px-2 py-1 rounded-lg bg-white/5 hover:bg-white/10 transition-colors text-muted-foreground flex items-center gap-1"
                  >
            ...
            {loading ? (
              ...
              <div className="flex-1 flex flex-col">
                <div
                  className="flex-1 px-4 py-4 text-sm leading-relaxed whitespace-pre-wrap text-foreground overflow-auto"
                ...
                <div className="border-t border-border px-4 py-3 grid grid-cols-3 gap-2">
                  {[
                    ...
                    { icon: Clock, label: "Latency", value: `${result.latencyMs}ms` },
                    {
                      icon: Coins,
                      label: "Cost",
                      value: result.costUsd < 0.0001 ? "<$0.0001" : `$${result.costUsd.toFixed(4)}`,
                    },
                  ].map((s) => (
        ...
        <div className="space-y-3">
          ...
          {[
            ...
            },
            {
              ...
              a: "GPT-4o mini (fast and cheap, great for most tasks), GPT-4o (smarter, best quality), and GPT-4 Turbo (powerful, long context). More models coming soon.",
            },
            {
              q: "What does temperature do?",
              a: "Temperature controls randomness. 0 = deterministic, precise answers. 2 = highly creative and varied. For factual tasks use 0–0.3. For creative tasks use 0.7–1.2.",
            },
            {
        ...
        <div className="text-center pt-2">
          ...
          <div className="flex flex-wrap gap-2 justify-center mt-2">
            ...
            <Link
              href="/tools"
              className="text-sm px-3 py-1.5 rounded-lg border border-border hover:bg-muted/50 transition-colors flex items-center gap-1"
            >
