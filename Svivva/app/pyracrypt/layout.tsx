  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: { "@type": "Answer", text: "Yes — completely free, no sign-up, no limits on the core encryption tool. Paid plans unlock advanced scanning, team seats, and reporting." },
    },
    {
      "@type": "Question",
      name: "Where do my files go when I use Pyracrypt?",
      acceptedAnswer: { "@type": "Answer", text: "Nowhere. Pyracrypt processes everything locally in your browser using the Web Crypto API. Files never touch a server." },
    },
    {
      "@type": "Question",
      name: "Can I decrypt Pyracrypt files without Pyracrypt?",
      acceptedAnswer: { "@type": "Answer", text: "Yes. Pyracrypt uses standard AES-256-GCM. Any tool that supports this cipher can decrypt your files if you have the key." },
    },
    {
      "@type": "Question",
      name: "What encryption standard does Pyracrypt use?",
      acceptedAnswer: { "@type": "Answer", text: "Pyracrypt uses AES-256-GCM — the same standard used by government agencies and financial institutions worldwide. Encryption runs entirely in your browser via the Web Crypto API." },
    },
    {
      "@type": "Question",
      name: "Does Pyracrypt work offline?",
      acceptedAnswer: { "@type": "Answer", text: "Once loaded, Pyracrypt can encrypt and decrypt files without an internet connection, since all processing happens locally in your browser." },
    },
  ],
};
...
const softwareSchema = {
  ...
  description: "Free browser-based file encryption using AES-256-GCM. No sign-up, no server uploads. Files never leave your device.",
  url: "https://svivva.com/pyracrypt",
};
