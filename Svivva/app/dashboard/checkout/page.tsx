  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5" data-testid="form-checkout">
      <div
        ...
        style={{ border: `1px solid ${plan.color}30`, background: "rgba(0,0,0,0.3)" }}
      >
        <div
          className="px-4 py-3 flex items-center gap-2 border-b"
          style={{ borderColor: `${plan.color}20`, background: `${plan.color}08` }}
        >
          ...
          <div className="ml-auto flex items-center gap-1.5">
            {["visa", "mc", "amex"].map((c) => (
              <div
                key={c}
                className="w-8 h-5 rounded bg-white/10 border border-white/10 flex items-center justify-center"
              >
  ...
  useEffect(() => {
    fetch("/api/stripe/publishable-key")
      ...
      .then((data) => {
        ...
        else setError("Payment system unavailable");
      })
          ...
          <div className="order-2 lg:order-1">
            ...
            >
              ...
              <div
                ...
                style={{
                  background: `linear-gradient(to right, ${plan.color}, ${plan.color}60, transparent)`,
                }}
              />
                ...
                {showDemoMode ? (
                  <div className="space-y-5">
                    <div
                      ...
                      style={{ border: `1px solid ${plan.color}25`, background: `${plan.color}08` }}
                    >
                      ...
                      <p className="text-xs text-muted-foreground">
                        Click Upgrade from the billing page to activate the live payment form.
                      </p>
                    </div>
                    <div
                      className="rounded-2xl overflow-hidden"
                      style={{ border: `1px solid ${plan.color}20`, background: "rgba(0,0,0,0.2)" }}
                    >
                      <div
                        className="px-4 py-3 flex items-center gap-2 border-b"
                        style={{ borderColor: `${plan.color}15` }}
                      >
                        <CreditCard className="w-4 h-4" style={{ color: plan.color }} />
                        <span className="text-sm font-medium">Payment Details</span>
                      </div>
                    ...
                    <Button
                      disabled
                      className="w-full h-12 rounded-2xl font-bold gap-2 opacity-50"
                      style={{ background: plan.color }}
                      data-testid="button-confirm-payment-preview"
                    >
                      <Lock className="w-4 h-4" />
                      Subscribe — {plan.price}
                      {plan.period}
                  ...
                  <div className="text-center py-12 space-y-4">
                    ...
                    <Link href="/dashboard/billing">
                      <Button variant="outline" data-testid="button-back-billing-error">
                        Return to Billing
                      </Button>
                    </Link>
                  </div>
                  ...
                  >
                    <CheckoutForm
                      tier={tierParam}
                      onSuccess={() => router.push("/dashboard/billing?success=true")}
                    />
                  </Elements>
                ) : (
                  <div className="text-center py-12 space-y-4">
                  ...
                  <div className="relative">
                    ...
                    <div className="flex items-baseline gap-1 mb-5">
                      <span
                        ...
                        style={{
                          background: `linear-gradient(135deg, #fff 30%, ${plan.color}, #fff 70%)`,
              ...
              <div className="grid grid-cols-3 gap-2">
                {[
                  ...
                  <div
                    ...
                    style={{ border: `1px solid ${plan.color}15`, background: `${plan.color}05` }}
                  >
