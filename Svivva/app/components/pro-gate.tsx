  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] gap-6 px-4 text-center">
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        <Link href="/dashboard">
          <button
            className="h-11 px-6 rounded-xl font-bold text-sm border border-border hover:bg-muted/50 transition-colors"
      ...
      <div className="grid grid-cols-2 gap-3 text-sm max-w-sm w-full mt-2">
        {["Unlimited projects", "10,000 API calls/mo", "Full Eval Suite", "Priority support"].map(
          (f) => (
