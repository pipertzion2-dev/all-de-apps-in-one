...
const QUICK_ACTIONS = [
  { href: "/marketing-hub/campaigns", label: "New Campaign", description: "Launch a multi-channel campaign" },
  { href: "/marketing-hub/leads", label: "Capture Lead", description: "Add or import leads manually" },
  { href: "/marketing-hub/referrals", label: "Create Referral Link", description: "Generate a tracked referral link" },
  { href: "/marketing-hub/utm", label: "Build UTM URL", description: "Create a trackable campaign URL" },
  { href: "/marketing-hub/amplify", label: "Amplify Content", description: "Repurpose content across channels" },
  { href: "/marketing-hub/ab-tests", label: "Start A/B Test", description: "Test variants and find what converts" },
];
