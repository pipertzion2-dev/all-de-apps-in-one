  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center px-4">
      <div className="w-full max-w-xs text-center">
        ...
        <h1 className="text-xl font-semibold text-gray-900 mb-1" data-testid="text-gate-title">Enter Passcode</h1>
        ...
        {error && <p data-testid="text-gate-error" className="text-red-500 text-xs mb-2">{error}</p>}
