...
export async function POST(req: NextRequest) {
  try {
    ...
    doc.fontSize(9).fillColor("#aaaaaa").text("hello@zzaizzai.com", 50, 100);
    ...
    doc
      ...
      .fillColor("#999999")
      .text(
        "This blueprint was generated by ZZAI Hardware Builder. For questions, contact hello@zzaizzai.com",
        { align: "center" },
      );
    doc.text("© ZZAI " + new Date().getFullYear(), { align: "center" });
