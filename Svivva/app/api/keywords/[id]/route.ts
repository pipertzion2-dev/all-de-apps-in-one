...
export async function PATCH(
  ...
  try {
    ...
    if (typeof body.searchVolume === "number") updates.searchVolume = Math.max(0, Math.round(body.searchVolume));
    ...
    if (body.assignedPage !== undefined) updates.assignedPage = typeof body.assignedPage === "string" ? body.assignedPage : null;
    if (body.assignedArticle !== undefined) updates.assignedArticle = typeof body.assignedArticle === "string" ? body.assignedArticle : null;
