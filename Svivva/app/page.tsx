...
import { HomepageIntroGameFlow } from "@/components/homepage-intro-game-flow";
...
export default function LandingPage() {
  ...
  /** False until the intro game flow (loading → cube → Start) finishes. */
  const [introGameDone, setIntroGameDone] = useState(false);
  ...
  useEffect(() => {
    if (!flipComplete || !introGameDone) return;
    // Defer WebGL until intro + game handoff finish — mounting during the flip freezes scroll.
    const mountTimer = window.setTimeout(() => setCanMountHeavy3d(true), 200);
    return () => window.clearTimeout(mountTimer);
  }, [flipComplete, introGameDone]);
  ...
  useLayoutEffect(() => {
    ...
    const skipToHomepage = () => {
      finishIntro();
      setIntroGameDone(true);
    };

    skipIntroRef.current = skipToHomepage;
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {!introGameDone ? (
            <HomepageIntroGameFlow onEnterHomepage={() => setIntroGameDone(true)} />
          ) : (
            <>
                          ...
                          <div className="flex flex-col md:flex-row items-center gap-6 sm:gap-8">
                            ...
                            <div className="flex-1 text-center md:text-left space-y-3">
                              ...
                              <p className="text-sm sm:text-base text-muted-foreground max-w-lg">
                                ...
                                <strong>buses</strong> sum your signal through{" "}
                                <strong>Signal</strong> or <strong>Crest</strong> mains to the{" "}
                              ...
                              <div className="flex items-center gap-3 sm:gap-4 min-w-0">
                                ...
                                <div className="min-w-0">
                                  ...
                                  <p className="text-sm text-muted-foreground mt-1 max-w-xl">
                                    Track event attendance, check-ins, and payment divvy — who
                                    gives, who receives. Live desk for shows, pop-ups, and community
                                    nights.
                                  </p>
                                </div>
                              </div>
                  ...
                  <div className="max-w-7xl mx-auto px-4 sm:px-6">
                    <div className="text-center space-y-4 mb-16">
                      ...
                      <p className="text-base sm:text-xl text-muted-foreground max-w-2xl mx-auto mt-6">
                        Bring Users Into Logical Delivery — our guided process takes you from
                    ...
                    <div className="mt-12 text-center">
                      <a href="/signup">
                        ...
                        >
                          {mode === "digital"
                            ? "Enter Signal — Build APIs"
                            : "Enter Crest — Manufacture"}
                          <ArrowRight className="w-4 h-4" />
                        </Button>
                      </a>
                    </div>
                      ...
                      <div className="order-1 lg:order-2 space-y-6">
                        ...
                        <div className="space-y-4 text-muted-foreground leading-relaxed">
                          <p>
                            ...
                            afternoon walks, he developed a quiet obsession with flowers, plants,
                            and herbs — the way they grow, the way they smell, and above everything
                            else, the way they hold color.
                          </p>
                          <p>
                            ...
                            catches light next to digital noise. When I started designing ZZAI, he
                            was right there next to me. The cyan and magenta you see throughout the
                            app? His picks — the same dual energy inside the ZZAI crest.
                          </p>
                          <p>
                            The ZZAI mark — ornate silver crest, Yeoo-style lettering, glitch
                            texture — is the brand signal for ZZAI. Crest on one side, Signal on the
                            other. Ornate and digital at once. That duality is the product: Prompt
                            to API, and manufacturing when you need hardware.
                          </p>
                          <p className="text-foreground/80 font-medium">
                            We're building ZZAI to last. Not just as a platform for developers, but
                            as something a six-year-old can one day point to and say he helped make
                            beautiful.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="grid lg:grid-cols-3 gap-6 mb-12">
                          ...
                          <div className="p-5 space-y-4">
                            ...
                            <div className="bg-black/40 rounded-lg p-4 border border-white/10">
                              <p className="text-sm text-gray-200 italic">
                                &quot;Analyze customer feedback to extract sentiment, identify key
                                topics, and provide a confidence score. Handle multiple
                                languages.&quot;
                              </p>
                            </div>
                        ...
                        <Card className="bg-slate-900/90 backdrop-blur-xl border-[#D782B2]/30 rounded-2xl overflow-visible hover-elevate active-elevate-2">
                          <div className="flex items-center gap-3 px-4 py-3 border-b border-[#D782B2]/20 bg-[#D782B2]/10">
                            ...
                            <span className="font-semibold text-[#D782B2]">
                              2. Generated Schema
                            </span>
                          </div>
                      ...
                      <div className="grid lg:grid-cols-3 gap-6 mb-12">
                        <Card className="bg-slate-900/90 backdrop-blur-xl border-[#D94F9C]/30 rounded-2xl overflow-visible hover-elevate active-elevate-2">
                          ...
                          <div className="p-5 space-y-4">
                            ...
                            <div className="bg-black/40 rounded-lg p-4 border border-white/10">
                              <p className="text-sm text-gray-200 italic">
                                &quot;A modular desk organizer with 3 compartments, made from
                                sustainable bamboo, fits standard office supplies.&quot;
                              </p>
                            </div>
                            <div className="flex items-center gap-2 text-xs text-gray-400">
                              <Check className="w-3.5 h-3.5 text-green-400" />
                        ...
                        <Card className="bg-slate-900/90 backdrop-blur-xl border-[#63B3A6]/30 rounded-2xl overflow-visible hover-elevate active-elevate-2">
                          <div className="flex items-center gap-3 px-4 py-3 border-b border-[#63B3A6]/20 bg-[#63B3A6]/10">
                            ...
                            <span className="font-semibold text-[#63B3A6]">
                              3. Production Ready
                            </span>
                          </div>
                          <div className="p-5 space-y-4">
                    ...
                    {mode === "digital" ? (
                      <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
                        <div className="space-y-6 bg-background/85 backdrop-blur-xl rounded-2xl p-5 sm:p-8">
                          ...
                          <p className="text-base sm:text-xl text-muted-foreground">
                            ...
                            inputs, malformed data. When pass rates drop, we roll back
                            automatically. You sleep soundly.
                          </p>
                          <div className="space-y-4">
                      ...
                      <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
                        <div className="space-y-6 bg-background/85 backdrop-blur-xl rounded-2xl p-5 sm:p-8">
                          ...
                          <p className="text-base sm:text-xl text-muted-foreground">
                            AI stress-tests your design for manufacturability before you spend a
                            dime on materials. Material conflicts, tolerance issues, cost
                            overruns—caught early, fixed fast.
                          </p>
                          <div className="space-y-4">
                            <div className="flex gap-4">
                              <div className="w-10 h-10 rounded-full bg-green-500/20 flex items-center justify-center flex-shrink-0">
                            ...
                            <div className="flex gap-4">
                              ...
                              <div>
                                ...
                                <p className="text-muted-foreground text-sm">
                                  Suggests material alternatives to reduce costs without quality
                                  loss
                                </p>
                              </div>
                            </div>
