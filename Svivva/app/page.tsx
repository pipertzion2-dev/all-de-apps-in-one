...
export default function LandingPage() {
  ...
  useLayoutEffect(() => {
    ...
    /** Map progress → full 180° rotateX (reveals hero beneath the intro card). */
    ...
    const paintFlip = (progress: number) => {
      ...
      // Stay fully opaque during flip — hero shows through as the card rotates away.
      ...
      if (clamped >= 0.82 && !introCubeInteractiveRef.current) {
