...
export const FEATURES: FeatureDef[] = [
  {
    ...
    description:
      "Play mini app — the music studio cube face. Hardware sampler UI, stems, patches, and neural audio workflows.",
  ...
  },
  {
    ...
    description:
      "Seeds mini app — CH 01 on the mixing board. PDF blueprint or YouTube transcript in; full-stack app suites out.",
  ...
  },
  {
    ...
    description:
      "Orbit mini app — SEO, indexing, Channel Intel, and traffic automation while you sleep.",
  ...
  },
  {
    ...
    description:
      "Protect mini app — deposit sketches, mint a protection coin, and build a court-ready pack.",
  ...
  },
  {
    ...
    description:
      "Digital mini app — the Signal path. Plain English becomes a production API with schema, evals, and rollback.",
  ...
  },
  {
    ...
    description:
      "Hardware mini app — the Crest path. AI schematics, material sourcing, and manufacturing from concept to part.",
