...
export function ReplitPATConnector({
  connected,
  ...
  return (
    ...
    >
      ...
      <div className="space-y-1.5 w-full">
        ...
        {!connected && !open && (
          <p className="text-muted-foreground">
            Click &ldquo;Connect Apps →&rdquo; and paste your Personal Access Token to link your
            account.
          </p>
        )}
      </div>
      ...
      <div className="flex items-start justify-between gap-2">
        <div>
          ...
          <p className="text-muted-foreground text-[10px] mt-0.5">
            In your app platform account → open <strong>Settings</strong> → scroll past SSH Keys →
            find <strong>&ldquo;Personal Access Tokens&rdquo;</strong> → click{" "}
            <strong>+ Create token</strong> → copy &amp; paste it here.
          </p>
        </div>
