...
/**
 * @param {{ url?: string; markers?: string[]; attempts?: number; delayMs?: number }} opts
 */
...
/** Infer verify URL + markers from changed paths in this deploy. */
export function deployVerifyTargets(changedFiles) {
