...
export const LONG_FORM_SECTIONS: Record<LongFormSectionId, LongFormSectionSpec> = {
  ...
  G: {
    ...
    interweaveMotifs: true,
    prompt:
      "Section G Glasper Dimension — rootless minor 11 clusters, Fadd2/A-style inversions, every chord contains 9/11/13 color, upper structures, drop-2, drop-2&4. Avoid ordinary ii-V-I motion.",
  },
  H: {
    id: "H",
