...
export const PlanStemSchema = z.object({
  name: z.string(),
  role: z.enum(["bass", "harmony", "melody", "percussion", "pad", "texture", "lead", "arpeggio", "vocal"]),
...
export const PlanSchema = z.object({
  ...
  motif_rules: z.array(z.object({
    rule: z.string(),
    applies_to: z.array(z.string()),
  })).optional(),
  harmony_rules: z.object({
...
export const PatchSchema = z.object({
  ...
  env: z.object({
    ...
    filter: z.object({ A: z.number(), D: z.number(), S: z.number(), R: z.number(), amount: z.number() }),
  }),
