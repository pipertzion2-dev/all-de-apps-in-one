  ...
  const items: GrowthOpportunity[] = [
    ...
    opp({
      ...
      scores: {
        ...
        growthVelocity: 90,
        lowCompetition: 75,
        contentReusability: 85,
      },
      recommendedAction: "ZZAI vs Lovable/Bolt comparison — schema validation + rollback angle",
    ...
    opp({
      ...
      recommendedAction: "Ship on zzaizzai.com/tools → CTA to Orbit",
