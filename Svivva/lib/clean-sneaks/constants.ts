...
> = {
  ...
  dirt: { label: "DIRT", color: "#6b4a32", w: 34, h: 16, jumpable: true },
  poop: { label: "POOP", color: "#4a2c14", w: 28, h: 20, jumpable: true },
  banana: { label: "BANANA", color: "#f0c830", w: 32, h: 14, jumpable: true },
