...
export const platformRuntimeSecrets = pgTable("platform_runtime_secrets", {
  ...
  interimPaypalUrlStarter: text("interim_paypal_url_starter"),
  interimPaypalUrlPro: text("interim_paypal_url_pro"),
  interimPaypalUrl: text("interim_paypal_url"),
  interimVenmoUrlStarter: text("interim_venmo_url_starter"),
  interimVenmoUrlPro: text("interim_venmo_url_pro"),
  interimVenmoUrl: text("interim_venmo_url"),
  interimCashAppUrlStarter: text("interim_cashapp_url_starter"),
  interimCashAppUrlPro: text("interim_cashapp_url_pro"),
  interimZelleContact: text("interim_zelle_contact"),
