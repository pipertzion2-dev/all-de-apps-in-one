...
export async function seedContent() {
  ...
  await db.insert(pageCategories).values([
    { slug: "ai-tools", name: "AI Tools", description: "Free AI-powered tools for developers and creators", metaTitle: "Free AI Tools | Svivva", metaDescription: "Discover free AI tools for text generation, code analysis, data processing, and more." },
    { slug: "developer-tools", name: "Developer Tools", description: "Essential tools for software developers", metaTitle: "Free Developer Tools | Svivva", metaDescription: "Free developer tools for API testing, code formatting, debugging, and productivity." },
    { slug: "api-tools", name: "API Tools", description: "Tools for building and testing APIs", metaTitle: "Free API Tools | Svivva", metaDescription: "Free API development tools for testing, documentation, schema validation, and monitoring." },
    { slug: "productivity", name: "Productivity", description: "Tools to boost your workflow efficiency", metaTitle: "Free Productivity Tools | Svivva", metaDescription: "Free productivity tools to streamline your development workflow and save time." },
  ]);
  ...
  await db.insert(seoLandingPages).values([
    {
      ...
      subheadline: "Condense long articles, documents, and text into clear, concise summaries in seconds.",
      content: "Long documents, research papers, and articles take valuable time to read. Whether you're a student reviewing course material, a professional catching up on industry reports, or a content creator researching topics, manually extracting key points is tedious and slow. Our AI Text Summarizer solves this problem by using advanced natural language processing to analyze your text and produce accurate, coherent summaries that capture the essential information. Unlike basic summarizers that simply truncate text, our tool understands context, identifies main arguments, and preserves the logical flow of ideas. It works with any type of content — from technical documentation to news articles to academic papers. The summarizer handles texts up to 10,000 words and produces summaries at adjustable lengths, so you can get a quick overview or a detailed condensation depending on your needs. Every summary maintains factual accuracy and proper attribution of key claims, ensuring you never miss critical information.",
      benefits: ["Save hours of reading time with instant AI-powered summaries", "Adjustable summary length from brief overview to detailed condensation", "Works with any content type — articles, papers, reports, documentation"],
      howItWorks: "Paste your text into the input field. Select your desired summary length (brief, medium, or detailed). Click 'Summarize' and our AI analyzes the text structure, identifies key themes and arguments, and generates a coherent summary. You can copy the result or regenerate for a different perspective.",
      whoItsFor: "Students summarizing research papers and study materials. Professionals reviewing lengthy reports and documentation. Content creators researching topics for articles. Anyone who needs to quickly understand long-form content.",
      ...
      metaDescription: "Summarize any text instantly with our free AI Text Summarizer. Condense articles, papers, and documents into clear summaries. No signup required.",
      published: true,
    },
    {
      ...
      subheadline: "Generate optimized prompts for ChatGPT, Claude, and other AI models to get better results.",
      content: "Getting good results from AI models depends heavily on how you write your prompts. Vague or poorly structured prompts lead to generic, unhelpful responses. Crafting effective prompts requires understanding prompt engineering patterns — few-shot examples, role assignment, constraint specification, and output formatting. Our AI Prompt Generator automates this process. Tell it what you want to achieve, and it generates professionally structured prompts optimized for the AI model you're using. It applies proven prompt engineering techniques including chain-of-thought reasoning, system role definition, and output schema specification. The generator supports multiple use cases — content creation, code generation, data analysis, creative writing, and business tasks. Each generated prompt includes clear instructions, relevant context, and specific output formatting to maximize the quality of AI responses.",
      benefits: ["Generate professionally structured prompts using proven engineering patterns", "Optimized for ChatGPT, Claude, GPT-4, and other major AI models", "Covers multiple use cases from coding to content creation to analysis"],
      howItWorks: "Describe your task or desired outcome in plain language. Select the target AI model and use case category. The generator applies prompt engineering best practices — role assignment, few-shot examples, output formatting — to create an optimized prompt. Copy the result and paste it into your preferred AI tool.",
      whoItsFor: "Developers building AI-powered applications. Content creators working with AI writing tools. Business professionals using AI for analysis and reports. Anyone looking to get better results from ChatGPT and other AI models.",
      ...
      metaDescription: "Generate optimized prompts for ChatGPT, Claude, and GPT-4. Free AI Prompt Generator with proven engineering patterns. No signup required.",
      published: true,
    },
    {
      ...
      subheadline: "Automatically generate JSON Schema from sample JSON data for API validation and documentation.",
      content: "Defining JSON schemas manually is error-prone and time-consuming, especially for complex nested data structures. Incorrect schemas lead to validation failures, API integration issues, and runtime errors that are difficult to debug. Our JSON Schema Generator eliminates this problem by analyzing your sample JSON data and automatically producing a complete, valid JSON Schema definition. It correctly identifies data types, required fields, nested objects, arrays, and patterns. The generated schemas follow the JSON Schema Draft-07 specification and are compatible with popular validation libraries like Ajv, jsonschema, and Zod. Whether you're building REST APIs, configuring OpenAPI specifications, or setting up form validation, having accurate schemas is essential for data integrity and developer experience. The tool handles edge cases like nullable fields, mixed-type arrays, and deeply nested structures.",
      benefits: ["Instantly generate valid JSON Schema from any sample JSON data", "Supports Draft-07 specification compatible with Ajv, Zod, and OpenAPI", "Handles complex nested objects, arrays, nullable fields, and patterns"],
      howItWorks: "Paste your sample JSON data into the input field. The generator analyzes the structure, identifies types and constraints, and produces a complete JSON Schema. You can customize required fields, add descriptions, and set additional constraints. Export the schema for use in your API validation, OpenAPI specs, or form libraries.",
      whoItsFor: "API developers who need schemas for request/response validation. Backend engineers building OpenAPI documentation. Frontend developers creating form validation rules. DevOps teams configuring data pipeline schemas.",
      ...
      metaDescription: "Generate JSON Schema from sample data instantly. Free JSON Schema Generator supporting Draft-07, Ajv, and OpenAPI. No signup required.",
      published: true,
    },
    {
      slug: "json-formatter",
      ...
      metaDescription: "Format, validate, and beautify JSON online. Free JSON Formatter with syntax highlighting and error detection. No signup required.",
      published: true,
    },
    {
      ...
      subheadline: "Validate API responses against JSON schemas to ensure data integrity and catch errors early.",
      content: "APIs are the backbone of modern software, but ensuring they return correct data is an ongoing challenge. Schema mismatches between what an API promises and what it actually returns cause cascading failures across your application. Manual testing catches obvious issues but misses edge cases — nullable fields that should be required, incorrect data types, missing nested properties, and inconsistent array structures. Our API Response Validator checks your API responses against JSON Schema definitions to catch every discrepancy. It performs deep structural validation, type checking, format verification (dates, emails, URLs), and constraint validation (min/max, pattern matching, enum values). The validator produces detailed reports showing exactly which fields failed validation and why, making it easy to fix issues before they reach production.",
      benefits: ["Deep structural validation against JSON Schema with detailed error reports", "Catches type mismatches, missing fields, format violations, and constraint failures", "Prevents cascading failures by validating data before it reaches your frontend"],
      howItWorks: "Enter your API response JSON and the expected JSON Schema. The validator performs comprehensive checks — structure matching, type verification, format validation, and constraint checking. Results show a pass/fail status for each field with specific error messages. Fix issues and re-validate until your response matches the schema perfectly.",
      whoItsFor: "API developers verifying endpoint responses during development. QA engineers building API test suites. Frontend developers validating data from backend services. Teams implementing contract testing between services.",
      ...
      metaDescription: "Validate API responses against JSON schemas. Free API Response Validator with detailed error reports. No signup required.",
      published: true,
    },
    {
      slug: "base64-encoder",
      ...
      subheadline: "Encode text and files to Base64 or decode Base64 strings instantly in your browser.",
      content: "Base64 encoding is essential for embedding binary data in text-based formats like JSON, XML, HTML, and email. Developers regularly need to encode API keys, images, certificates, and binary payloads for transmission over text protocols. Decoding Base64 is equally important for debugging encoded data in API responses, JWT tokens, and configuration files. Our Base64 Encoder and Decoder handles both directions instantly in your browser with zero server-side processing — your data never leaves your machine. It supports text encoding/decoding with multiple character sets (UTF-8, ASCII, ISO-8859-1), file encoding for images and documents, and URL-safe Base64 variants. The tool also detects and handles common issues like padding errors, line breaks in encoded strings, and mixed encoding formats.",
      benefits: ["100% client-side processing — your data never leaves your browser", "Supports text, files, images, and URL-safe Base64 variants", "Handles UTF-8, ASCII, and multiple character encodings"],
      howItWorks: "Choose encode or decode mode. For encoding, paste your text or upload a file. For decoding, paste the Base64 string. The tool processes everything locally in your browser and shows the result instantly. Copy the output or download as a file.",
      whoItsFor: "Developers working with API authentication tokens and encoded payloads. DevOps engineers handling certificates and encoded configuration. Frontend developers embedding images as data URIs. Anyone debugging Base64-encoded data in logs or responses.",
      relatedSlugs: ["json-formatter", "jwt-decoder", "url-encoder"],
      category: "developer-tools",
      metaTitle: "Free Base64 Encoder & Decoder - Encode Decode Online | Svivva",
      metaDescription: "Encode and decode Base64 online for free. Client-side processing, supports text and files. No signup required.",
      published: true,
    },
    {
      ...
      subheadline: "Rewrite paragraphs to improve clarity, change tone, or create unique versions of existing content.",
      content: "Creating unique, high-quality content variations is essential for marketing, SEO, academic writing, and professional communication. Whether you need to rephrase content for different audiences, improve readability, adjust formality levels, or create alternative versions for A/B testing, manually rewriting text is slow and often introduces awkward phrasing. Our AI Paragraph Rewriter uses advanced language models to intelligently restructure and rephrase your text while preserving the original meaning. Unlike simple synonym-swapping tools, it understands context, maintains logical flow, and produces natural-sounding output. Choose from multiple rewriting styles — professional, casual, academic, simplified, or creative — to match your target audience. The tool supports paragraphs up to 1,000 words and generates multiple variations so you can pick the best one.",
      benefits: ["Multiple rewriting styles — professional, casual, academic, simplified, creative", "Preserves original meaning while creating genuinely unique variations", "Generates multiple alternatives so you can choose the best version"],
      howItWorks: "Paste your paragraph into the input field. Select the desired tone and style. Click 'Rewrite' and the AI analyzes your text's meaning, structure, and intent, then produces a rewritten version that sounds natural and preserves key information. Generate multiple variations and pick your favorite.",
      whoItsFor: "Content marketers creating variations for A/B testing and multi-channel distribution. Students paraphrasing research material for essays and papers. Business professionals adjusting communication tone for different audiences. SEO specialists creating unique content variations.",
      ...
      metaDescription: "Rewrite paragraphs with AI to improve clarity and change tone. Free AI Paragraph Rewriter with multiple styles. No signup required.",
      published: true,
    },
    {
      ...
      benefits: ["Accurate detection across GPT-4, Claude, Gemini, and other major AI models", "Confidence scoring with highlighted sections showing AI-writing patterns", "Works with 50-5,000 word texts for thorough analysis"],
      howItWorks: "Paste the text you want to analyze. The detector examines linguistic patterns including perplexity, burstiness, and stylistic markers. It returns a confidence score (0-100%) indicating the likelihood of AI authorship, with specific sections highlighted that show the strongest AI-writing characteristics.",
      whoItsFor: "Educators checking student submissions for AI-generated content. Content managers ensuring authentic human-written material. Publishers maintaining editorial standards. Hiring teams reviewing AI-assisted applications.",
      ...
      metaDescription: "Detect AI-generated text with confidence scoring. Free AI Content Detector for GPT-4, Claude, and more. No signup required.",
      published: true,
    },
    {
      slug: "jwt-decoder",
      ...
      content: "JSON Web Tokens (JWTs) are the standard authentication mechanism for modern APIs, but their Base64-encoded format makes them opaque and difficult to debug. When authentication fails or token-related issues arise, you need to quickly inspect the token's contents — claims, expiration times, issuer information, and signing algorithm. Our JWT Decoder instantly breaks down any JWT into its three components: header (algorithm and token type), payload (all claims and custom data), and signature verification status. It highlights important fields like expiration time (exp), issued-at time (iat), subject (sub), and audience (aud) with human-readable formatting. The decoder detects expired tokens, identifies the signing algorithm, and flags common issues like clock skew and missing required claims. All processing happens client-side in your browser — your tokens are never sent to a server.",
      benefits: ["Instant decode with clear display of header, payload, and signature", "Expiration detection, algorithm identification, and claim validation", "100% client-side — your tokens never leave your browser"],
      howItWorks: "Paste your JWT token into the input field. The decoder splits it into header, payload, and signature sections, decoding the Base64 content and displaying all claims in a readable format. Expiration status, signing algorithm, and common issues are highlighted automatically.",
      whoItsFor: "Backend developers debugging authentication flows and token issues. Frontend developers troubleshooting API authorization failures. Security engineers auditing token configurations. DevOps teams diagnosing SSO and OAuth integration problems.",
      ...
      metaDescription: "Decode and inspect JWT tokens instantly. Free JWT Decoder showing header, payload, and claims. Client-side processing, no signup required.",
      published: true,
    },
    {
      slug: "url-encoder",
      ...
      subheadline: "Encode and decode URLs, query parameters, and special characters for safe transmission.",
      content: "URLs containing special characters, spaces, unicode, or reserved characters need proper encoding to work correctly in web applications. Improperly encoded URLs cause broken links, failed API requests, and data corruption. Whether you're building query strings, constructing redirect URLs, debugging encoded parameters, or working with internationalized domain names, correct URL encoding is essential. Our URL Encoder and Decoder handles both directions with support for standard percent-encoding (RFC 3986), component encoding for query parameters, and full URL encoding. It correctly handles unicode characters, reserved characters (+, &, =, ?, #), and multi-byte character sets. The tool also provides a breakdown of encoded components so you can understand exactly what each encoded sequence represents.",
      benefits: ["RFC 3986 compliant encoding for URLs, query strings, and components", "Handles unicode, reserved characters, and multi-byte character sets", "Component breakdown showing what each encoded sequence represents"],
      howItWorks: "Choose encode or decode mode. Paste your URL or text string. Select encoding type (full URL, component, or query parameter). The tool processes the input and shows the encoded/decoded result with a breakdown of special character handling. Copy the output for use in your application.",
      whoItsFor: "Web developers building URLs with query parameters and special characters. API developers constructing request URLs programmatically. SEO specialists working with URL structures and redirects. Anyone debugging URL encoding issues in web applications.",
      relatedSlugs: ["base64-encoder", "json-formatter", "jwt-decoder"],
      category: "developer-tools",
      metaTitle: "Free URL Encoder & Decoder - Encode URLs Online | Svivva",
      metaDescription: "Encode and decode URLs online for free. RFC 3986 compliant URL Encoder with unicode support. No signup required.",
      published: true,
    },
  ]);
  ...
  await db.insert(blogPosts).values([
    {
      ...
      excerpt: "Learn what AI APIs are, how they work, and how to build your own. This comprehensive guide covers everything from basic concepts to production deployment.",
...
*Ready to build your first AI API? [Get started with Svivva](/dashboard) and turn your prompts into production APIs in minutes.*`,
      ...
      metaDescription: "Learn what AI APIs are, how they work, and how to build production-ready AI APIs. Complete guide covering concepts, best practices, and deployment.",
      published: true,
    ...
    },
    {
      ...
      excerpt: "Master prompt engineering with these 10 proven techniques. Learn how to write prompts that produce consistent, high-quality AI outputs for your applications.",
...
*Want to apply these techniques at scale? [Start building with Svivva](/dashboard) to turn optimized prompts into production APIs with automated evaluation.*`,
      ...
      metaDescription: "Master prompt engineering with 10 proven techniques for consistent, high-quality AI outputs. Learn role assignment, few-shot, chain-of-thought, and more.",
      published: true,
    ...
    },
    {
      ...
      excerpt: "Discover why schema validation prevents costly production failures in AI APIs and how to implement it effectively with automated repair mechanisms.",
...
*Build AI APIs with guaranteed response formats. [Try Svivva](/dashboard) — schema enforcement included by default.*`,
      ...
      metaDescription: "Learn why JSON Schema validation prevents production failures in AI APIs. Discover schema enforcement and auto-repair techniques for reliable outputs.",
      published: true,
    ...
    },
    {
      ...
      excerpt: "Learn effective versioning and instant rollback strategies for AI APIs to maintain reliability while iterating on prompt improvements.",
...
*Ship AI APIs with confidence. [Start with Svivva](/dashboard) — versioning and rollback built in.*`,
      ...
      metaDescription: "Learn effective versioning and instant rollback strategies for AI-powered APIs. Automated evaluation, traffic shifting, and rollback triggers.",
      published: true,
    ...
    },
    {
      ...
      excerpt: "A step-by-step guide to creating, publishing, and monetizing AI APIs through marketplace platforms. Turn your prompts into revenue.",
...
*Ready to monetize your AI expertise? [Launch on Svivva's Marketplace](/dashboard/marketplace) and start earning from your AI APIs.*`,
      ...
      metaDescription: "Step-by-step guide to creating, publishing, and monetizing AI APIs. Learn pricing models, marketing strategies, and marketplace best practices.",
      published: true,
